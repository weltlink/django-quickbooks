...
from django_quickbooks.signals import invoice_line_created


@receiver(invoice_line_created)
def create_qbd_invoice_item(sender, model_obj_id, invoice_charges, realm_id, *args, **kwargs):
    """

    :param object sender: Sender model
    :param str model_obj_id: Invoice ID to which charges belonged
    ...
    invoice = Invoice.objects.get(external_id=model_obj_id, realm_id=realm_id)
